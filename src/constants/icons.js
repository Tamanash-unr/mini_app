...
const Game = "/assets/icons/game-def.png";
...
export default {Home, Store, Coins, Wallet, Placeholder, Gamepad, Friends, Gear, Pickaxe, FriendsPortrait, Game, Bolt, User, Copy, Gift, Crown, FullCrown}
